...
- Flowcharts, sequence diagrams, class diagrams, state diagrams, gantt charts, ER diagrams, mindmaps, gitgraphs — anything Mermaid supports works. See [[mermaid]] for a tour of the common diagram types with worked examples, or [[markdown]] for the pipeline detail.
